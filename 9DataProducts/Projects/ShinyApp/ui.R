...
shinyUI(fluidPage(
  # Application title
  headerPanel("CFBLNet Website User Analysis"),

  # Sidebar with a slider input for number of bins
  sidebarLayout(
    sidebarPanel(
        helpText(HTML("<h5>Analyze the user login data collected from 2012-2014 at the CFBLNet CPT web application (http://nc3a.info/cfblnet).</h5>")), hr(),
